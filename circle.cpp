...
int main() {
	...
	Rect rect(pt3, Size(200, 100));
	rectangle(image, rect, blue, FILLED, LINE_8);
	rectangle(image, rect, blue, FILLED, LINE_8,1);
...
int main() {
	...
	putText(image, "pt3", pt3, FONT_HERSHEY_COMPLEX, 1, green);

	circle(image, pt4, 100, blue, -1);
	imshow("paint", image);
	//setMouseCallback(title, onMouse, 0);
	waitKey();
